    ...
    <div class="bpanel-main-content">
        ...
        <div id="my-backup" class="tab-content">
        	<div class="bpanel-box">
                ...
                <div class="box-title"><h3><?php _e('Transfer Theme Options Data','spalab');?></h3></div>
                <div class="box-content">
                	<div><?php _e("You can tranfer the saved options data between different installs by copying the text inside the text box. To import data from another install, replace the data in the text box with the one from another install and click 'Import Options'",'spalab');?></div>
                    <div class="clar"></div>
                    <div class="hr_invisible"></div>
                    ...
                    <div class="clear"></div>
                    <div class="hr_invisible"></div>
                    <a href="#" id="mytheme_import_button" class="bpanel-button black-btn" title="Restore Options"><?php _e('Import Options','spalab');?></a>
                </div>
